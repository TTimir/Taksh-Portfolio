    ...
    $( window ).on( 'elementor/frontend/init', function() {
        $('.pxl-grid').each(function(index, element) { 
            ...
            if( $grid_scope.hasClass('pxl-post-list')){
                ...
                $grid_scope.on('click', '.grid-filter-wrap .filter-item', function(e) {
                    ...
                    if( $this.closest('.grid-filter-wrap').hasClass('ajax') ){
                        ...
                        amoor_grid_ajax_handler( $this, $grid_scope, $grid_isotope, 
                            { action: 'amoor_load_more_post_grid', loadmore: loadmore, iso_options: isoOptions, handler_click: 'filter', scrolltop: 0, wpnonce: main_data.wpnonce }
                        );
                    }else{
            ...
            $grid_scope.on('click', '.pxl-grid-pagination .ajax a.page-numbers', function(e) {
                ...
                amoor_grid_ajax_handler( $this, $grid_scope, $grid_isotope, 
                    { action: 'amoor_load_more_post_grid', loadmore: loadmore, iso_options: isoOptions, handler_click: 'pagination', scrolltop: 1, wpnonce: main_data.wpnonce }
                );
            });
            ...
            $grid_scope.on('click', '.btn-grid-loadmore', function(e) {
                ...
                amoor_grid_ajax_handler( $this, $grid_scope, $grid_isotope, 
                    { action: 'amoor_load_more_post_grid', loadmore: loadmore, iso_options: isoOptions, handler_click: 'loadmore', scrolltop: 0, wpnonce: main_data.wpnonce }
                );
            });
            $grid_scope.on('change', '.orderby', function(e) {
                ...
                amoor_grid_ajax_handler( $this, $grid_scope, $grid_isotope, 
                    { action: 'amoor_load_more_post_grid', loadmore: loadmore, iso_options: isoOptions, handler_click: 'select_orderby', scrolltop: 0, wpnonce: main_data.wpnonce }
                );
            });
        });

        function amoor_grid_ajax_handler($this, $grid_scope, $grid_isotope, args = {}){
